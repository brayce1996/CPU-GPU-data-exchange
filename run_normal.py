...
while grid_size < 4096:
    ...
    os.system("perf stat -e faults ./{} {} {} 2>&1 >/dev/null | awk '{{if ($2 == \"faults\") {{print $1}} }}' >> ./{}/{}_{}_pagefaults".format(executable, grid_size, enable_pinned_memory, output_folder, executable, enable_pinned_memory_str))
